...
const SignupSchema = Yup.object().shape({
  ...
  avatar: Yup.string().min(2, 'Too Short!').max(240, 'Too Long!').required('Required'),
...
export const Registration = () => {
  ...
  async function fetchRegister(credentials: Credentials) {
    ...
    if (res.ok) {
      setMessage('Successfully registered! Wait a second for login page redirection...');
      setTimeout(() => {
          ...
          {() => (
            <Form className="max-w-md mx-auto space-y-4">
              ...
              <div>
                ...
                <Field name="name" type="text" className="mt-1 block w-full border rounded-md px-3 py-2" />
              ...
              <div>
                ...
                <Field as="select" name="role" id="role" className="mt-1 block w-full border rounded-md px-3 py-2">
              ...
              <div>
                ...
                <Field name="avatar" type="text" className="mt-1 block w-full border rounded-md px-3 py-2" />
