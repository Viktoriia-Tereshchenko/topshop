...
const ProductDetailPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f5f4fa] flex flex-col py-[120px]">
      <Container>
        <div className="flex-1 flex justify-center items-stretch size-full">
          <div
            className=" grid grid-cols-[1fr_4fr_5fr_4fr] gap-5
            size-full px-5 py-10 bg-white rounded-xl shadow-lg overflow-hidden"
          >
            {/* 1. Thumbnails */}
            ...
            <div className="">
              <img
                src={product.images[hoveredImage ?? activeImage]}
                alt={product.title}
                className="object-contain w-full rounded-2xl shadow transition-all duration-200"
              />
            </div>
            {/* 3. Info/Description */}
            <div className="flex flex-col gap-4]">
              ...
              <div>
                ...
                >
                  ...
                  <span
                    className={`ml-2 transition-transform duration-200 text-gray-400 group-hover:text-blue-500 ${
                ...
                <div
                  className={`overflow-hidden transition-all duration-300 ${
                    isDescriptionOpen ? 'max-h-[400px] opacity-100' : 'max-h-0 opacity-0'
                  }`}
                >
            ...
            {/* 4. Sidebar */}
            <div className="bg-white border border-gray-200 rounded-xl shadow-md p-6 flex flex-col gap-4">
              <div className="font-bold text-gray-900 text-[22px]">${product.price}</div>
              <a href="#" className="text-blue-600 text-[13px] underline">
                FREE Returns
              </a>
              <div className="text-[13px] text-gray-700">
                FREE delivery <b>2 - 5 August</b>. Order within{' '}
                <span className="text-green-700 font-semibold">18 hrs 29 mins</span>.{' '}
              ...
              <button
                className="w-full text-sm bg-yellow-400 hover:bg-yellow-500 text-black py-2 px-6 rounded shadow hover:shadow-lg transition-all duration-200 flex items-center justify-center gap-2"
              ...
              {isAuthorized && (
                <>
                  <button
                    className="w-full text-sm bg-orange-500 hover:bg-orange-600 text-white py-2 px-6 rounded shadow hover:shadow-lg transition-all duration-200 flex items-center justify-center gap-2"
                  ...
                  <button
                    className="w-full text-sm bg-blue-500 hover:bg-blue-600 text-white py-2 px-6 rounded shadow hover:shadow-lg transition-all duration-200 flex items-center justify-center gap-2"
                    onClick={() => navigate('/products')}
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
              ...
              <div className="text-[13px] text-gray-500 mt-2">
                ...
                . For further information, company details, terms and conditions, and cancellation rights, please click
